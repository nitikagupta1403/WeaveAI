...
## Section 3 — Hierarchy of Scientific Representations
...
This manuscript presents the complete scientific methodology proposed in this work. Rather than describing a sequence of computational algorithms, the framework is organized as a hierarchy of progressively richer scientific representations. Each representation is introduced only when the preceding representation becomes insufficient to answer the next scientific question, thereby establishing an interpretable progression from raw garment geometry to semantic reasoning.

---

# 3. Hierarchy of Scientific Representations

The proposed framework progressively transforms raw garment sketches into increasingly expressive computational representations. Beginning with localized contour geometry, the framework successively learns reusable geometry primitives, symbolic garment representations, visual grammar, primitive morphology, semantic representations, and finally higher-order semantic reasoning. Each representation extends the descriptive capability of the previous representation while preserving explicit traceability to the original garment geometry.

Figure 3.1 summarizes the hierarchy of scientific representations proposed in this work.
...
|----------|------|--------|-------------|
| 1.0 | 10 Aug 2026 | Working Draft | Initial scientific architecture of Section 3 |
