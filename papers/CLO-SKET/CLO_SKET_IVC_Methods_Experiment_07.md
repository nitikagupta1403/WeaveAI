...
The exact 2,300×14 axial–radial matrix, category labels, garment identities, and row-level fold assignment used by Experiment 07 were recovered from the frozen historical Experiment-06 checkpoint. Before Experiment-07 outcomes were computed, that checkpoint fold map reproduced the historical Experiment-06 pooled results to numerical precision: morphology macro-F1 0.297788 and balanced accuracy 0.298261; morphology plus the complete axial–radial block macro-F1 0.335765 and balanced accuracy 0.336087. The frozen Experiment-07 test-fold sizes were therefore 459, 460, 462, 460, and 459 sketches, with 46 held-out historical garment identities per fold, 184 training identities, and zero train/test garment-identity overlap in every fold. These folds remain authoritative for Experiment 07 itself but are not the corrected Experiment-06 primary folds used for the manuscript-facing corrective analysis.
...
Two feature sets were then evaluated under the same fold-local preprocessing and classifier specification used by the frozen historical Experiment-06 package:
...
Experiment 07 is interpreted strictly as a secondary conventional-descriptor comparator under its own frozen historical fold provenance. It tests whether the explicit 14-dimensional axial–radial representation supplied measurable incremental predictive benefit after a high-dimensional local-gradient representation was already present. It is not a new primary hypothesis, is not a same-fold rerun of the later corrective CLEAN Experiment-06 analysis, and does not replace the corrected morphology-based primary comparison.
