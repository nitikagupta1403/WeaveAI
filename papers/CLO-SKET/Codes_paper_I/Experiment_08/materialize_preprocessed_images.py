...
OUTPUT_SIZE = 224
CONTENT_SIZE = 196  # 14 ViT-S/14 patches; one 14-pixel patch border per side.
...
def main() -> None:
    ...
    report = {
        ...
        "maximum_content_extent": CONTENT_SIZE,
        "vit_patch_size": 14,
        "augmentation": "none",
        "localization_policy": (
            "Crop to the frozen garment box, whiten intersecting reviewed text "
            "boxes, resize the longest content side to 196 pixels, and center "
            "on a 224x224 white canvas with an architecture-aligned patch border"
        ),
